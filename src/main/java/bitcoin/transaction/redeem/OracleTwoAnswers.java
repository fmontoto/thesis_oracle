...
public class OracleTwoAnswers {
    ...
    public OracleTwoAnswers(BitcoinPublicKey[] playersPubKey, long timeoutSeconds) {
    ...
    public static OracleTwoAnswers build(
        ...
        oracleTwoAnswers.findRedeemScript(expectedHash, r160SHA256Hash(playerAAnswer),
        ...
        tx.getInput(0).setScript(redeemTwoAnswers(oracleTwoAnswers.redeemScript,
